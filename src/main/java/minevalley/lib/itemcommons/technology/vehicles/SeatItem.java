...
public class SeatItem implements CustomItem {
    ...
    public static void registerRecipes() {
        final CustomShapedRecipe recipe = Crafting.createCustomRecipe(SEAT_ITEM, new String[]{"W    ", "S    ", "W    ", "WL   ", " HWW "}, 20_000);
        ...
        final CustomShapedRecipe leatherRecipe = Crafting.createCustomRecipe(LEATHER_SEAT_ITEM, new String[]{"W    ", "S    ", "W    ", "WL   ", " HWW "}, 20_000);
