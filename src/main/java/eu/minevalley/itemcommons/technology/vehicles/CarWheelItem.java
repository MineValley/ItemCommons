...
public class CarWheelItem implements CustomItem {
    ...
    public static final ItemStack CAR_WHEEL_NORMAL_ITEM = ItemCommons.core().createItem(SKULL)
    ...
    public static final ItemStack CAR_WHEEL_SPEED_ITEM = ItemCommons.core().createItem(SKULL)
            .setDisplayName(DISPLAY_NAME)
    ...
    public static final ItemStack CAR_WHEEL_HANDLING_ITEM = ItemCommons.core().createItem(SKULL)
            .setDisplayName(DISPLAY_NAME)
